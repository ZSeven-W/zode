...
- **TUI plein écran** : Markdown en streaming, coloration syntaxique, diff preview, autocomplétion des slash commands, historique, thèmes, overlays settings/help et UI en 15 langues (`/language`).
