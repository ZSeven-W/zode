//! Cross-agent MCP server discovery: merge claude / cursor / vscode /
//! opencode / codex-style config files and plugin declarations into zode's
//! normalized `{servers:{...transport...}}` shape, with the home-vs-workspace
//! trust boundary applied (workspace-declared servers default to disabled).
